<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('contactCompany.company_name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="company_name" id="company_name" wire:model="contactCompany.company_name">
    ...
    <div class="form-group {{ $errors->has('contactCompany.company_address') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="company_address" id="company_address" wire:model="contactCompany.company_address">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactCompany.company_website') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="company_website" id="company_website" wire:model="contactCompany.company_website">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactCompany.company_email') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="company_email" id="company_email" wire:model="contactCompany.company_email">
        <div class="validation-message">
    ...
    <div class="form-group">
        ...
        <a href="{{ route('contact-companies.index') }}" class="btn btn-secondary">
            {{ trans('global.cancel') }}
        </a>
    </div>
</form>
