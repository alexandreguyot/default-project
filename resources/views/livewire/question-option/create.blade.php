<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('questionOption.question_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="question" name="question" :options="$this->listsForFields['question']" wire:model.live="questionOption.question_id" />
    ...
    <div class="form-group {{ $errors->has('questionOption.option_text') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="option_text" id="option_text" required wire:model="questionOption.option_text">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('questionOption.is_correct') ? 'invalid' : '' }}">
        <input class="form-control" type="checkbox" name="is_correct" id="is_correct" wire:model="questionOption.is_correct">
