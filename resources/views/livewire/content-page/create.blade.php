<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('contentPage.page_text') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="page_text" id="page_text" wire:model="contentPage.page_text" rows="4"></textarea>
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contentPage.excerpt') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="excerpt" id="excerpt" wire:model="contentPage.excerpt" rows="4"></textarea>
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.content_page_featured_image') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="featured_image" name="featured_image" action="{{ route('content-pages.storeMedia') }}" collection-name="content_page_featured_image" max-file-size="2" max-width="4096" max-height="4096" max-files="1" />
        <div class="validation-message">
