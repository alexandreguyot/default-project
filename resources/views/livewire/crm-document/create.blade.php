<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('crmDocument.customer_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" required id="customer" name="customer" :options="$this->listsForFields['customer']" wire:model.live="crmDocument.customer_id" />
    ...
    <div class="form-group {{ $errors->has('mediaCollections.crm_document_document_file') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="document_file" name="document_file" action="{{ route('crm-documents.storeMedia') }}" collection-name="crm_document_document_file" max-file-size="2" max-files="1" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmDocument.name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="name" id="name" required wire:model="crmDocument.name">
        <div class="validation-message">
