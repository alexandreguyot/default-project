<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('productCategory.name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="name" id="name" required wire:model="productCategory.name">
    ...
    <div class="form-group {{ $errors->has('productCategory.description') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="description" id="description" required wire:model="productCategory.description" rows="4"></textarea>
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('mediaCollections.product_category_photo') ? 'invalid' : '' }}">
        ...
        <x-dropzone id="photo" name="photo" action="{{ route('product-categories.storeMedia') }}" collection-name="product_category_photo" max-file-size="2" max-width="4096" max-height="4096" max-files="1" />
        <div class="validation-message">
