<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('faqQuestion.category_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" required id="category" name="category" :options="$this->listsForFields['category']" wire:model.live="faqQuestion.category_id" />
    ...
    <div class="form-group {{ $errors->has('faqQuestion.question') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="question" id="question" required wire:model="faqQuestion.question" rows="4"></textarea>
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('faqQuestion.answer') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="answer" id="answer" required wire:model="faqQuestion.answer" rows="4"></textarea>
        <div class="validation-message">
    ...
    <div class="form-group">
        ...
        <a href="{{ route('faq-questions.index') }}" class="btn btn-secondary">
            {{ trans('global.cancel') }}
        </a>
    </div>
</form>
