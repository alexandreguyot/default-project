<form wire:submit="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.first_name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="first_name" id="first_name" required wire:model="crmCustomer.first_name">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.last_name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="last_name" id="last_name" required wire:model="crmCustomer.last_name">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.status_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" required id="status" name="status" :options="$this->listsForFields['status']" wire:model.live="crmCustomer.status_id" />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.email') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="email" name="email" id="email" wire:model="crmCustomer.email">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.phone') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="phone" id="phone" wire:model="crmCustomer.phone">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.address') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="address" id="address" wire:model="crmCustomer.address">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.skype') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="skype" id="skype" wire:model="crmCustomer.skype">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.website') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="website" id="website" wire:model="crmCustomer.website">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('crmCustomer.description') ? 'invalid' : '' }}">
        ...
        <textarea class="form-control" name="description" id="description" wire:model="crmCustomer.description" rows="4"></textarea>
        <div class="validation-message">
