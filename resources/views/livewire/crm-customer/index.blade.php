            ...
            <table class="table table-index w-full">
                ...
                <tbody>
                    @forelse($crmCustomers as $crmCustomer)
                        <tr>
                            <td>
                                <input type="checkbox" value="{{ $crmCustomer->id }}" wire:model.live="selected">
                            </td>
                            <td>
                                {{ $crmCustomer->id }}
                            </td>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    @can('crm_customer_show')
                                        <a class="btn btn-sm btn-info mr-2" href="{{ route('crm-customers.show', $crmCustomer) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
                                    @can('crm_customer_edit')
                                        <a class="btn btn-sm btn-success mr-2" href="{{ route('crm-customers.edit', $crmCustomer) }}">
                                            {{ trans('global.edit') }}
                                        </a>
                                    @endcan
                                    @can('crm_customer_delete')
